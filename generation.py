...
def next_token_bar_chart(
    ...
    if show_ellipses:
        # Use Unicode vertical ellipsis to avoid LaTeX dependency
        ellipses = Text("⋮", font_size=font_size)
...
class SimpleAutogregression(InteractiveScene):
    ...
    seed_text = "There once was a ship that put to sea, The name of that"
